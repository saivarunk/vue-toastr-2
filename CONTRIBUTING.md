# vue-toastr-2 Contributing Guide
...
### Work Step Example
- Fork the repository from [saivarunk/vue-toastr-2](https://github.com/saivarunk/vue-toastr-2) !
- Create your topic branch from `master`: `git branch my-new-topic origin/master`
- Add codes and pass tests !
- Commit your changes: `git commit -am 'Add some topic'`
- Push to the branch: `git push origin my-new-topic`
- Submit a pull request to `master` branch of `saivarunk/vue-toastr-2` repository !
